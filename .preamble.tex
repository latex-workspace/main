...
\usetikzlibrary{er, positioning,patterns, external}
\usepackage{ccicons}
\usepackage{booktabs}
...
\definecolor{mutedgray}{RGB}{61, 61, 61}
...
\definecolor{mutedyellow}{RGB}{173, 156, 0}
...
\newsavebox{\defbox}
\newcounter{defcount}
\crefname{defcount}{definizione}{definizioni}
\Crefname{defcount}{Definizione}{Definizioni}
...
\newsavebox{\theoremsbox}
\newcounter{theoremscount}
\crefname{theoremscount}{teorema}{teoremi}
\Crefname{theoremscount}{Teorema}{Teoremi}
...
%%%%%%%%%%%%%%%%
\newcounter{formulascount}
\crefname{formulascount}{formula}{formule}
\Crefname{formulascount}{Formula}{Formule}
...
%%%%%%%%%%%%%%%%
\newcounter{exercisescount}
\crefname{exercisescount}{esercizio}{esercizi}
\Crefname{exercisescount}{Esercizio}{Esercizi}
...
\crefname{myalgorithmscount}{algoritmo}{algoritmi}
\Crefname{myalgorithmscount}{Algoritmo}{Algoritmi}
...
\crefname{commandscount}{comando}{comandi}
\Crefname{commandscount}{Comando}{Comandi}
...
\lstdefinelanguage{cpp}{
	classoffset = 1, keywordstyle = \color{mutedred}\textbf,
	morekeywords = {class, continue, default, enum, false, new, null, private, protected, public, static, true, void, return, do, for, if, else, switch, while, try, int, long, char, float, double, short, unsigned, auto, using, namespace, constexpr, bool, const, operator, register},
	%
	%
	classoffset = 2,keywordstyle = \color{mutedblue},
	...
	%
	%
	classoffset = 3,keywordstyle = \color{mutedyellow},
	morekeywords = {std, chrono, high_resolution_clock, vector, list, unordered_set, unordered_map},
	%
	%
	classoffset = 4,keywordstyle = \color{mutedcyan},
	...
	morestring=[b]",
	morestring=[d]',
	stringstyle = \color{mutedgreen},
	commentstyle = \color{mutedgray}\textit
}
...
\newcommand{\externalize}[1]{
	\tikzset{external/system call={pdflatex --shell-escape --fmt=#1 --halt-on-error -jobname "\image" "\texsource"}}
